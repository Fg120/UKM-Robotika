...
export default function DivisiEdit({ isOpen, onClose, divisiId }: DivisiEditProps) {
    ...
    const [formData, setFormData] = useState<{ nama: string; deskripsi: string; image: File | null }>({ nama: '', deskripsi: '', image: null });
    ...
    const loadDivisi = async () => {
        ...
        try {
            ...
            setFormData({ nama: data.divisi.nama, deskripsi: data.divisi.deskripsi || '', image: null });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        setErrors({});
        const payload: any = { nama: formData.nama, deskripsi: formData.deskripsi };
    ...
    const handleClose = () => {
        if (!isLoading) { setDivisi(null); setFormData({ nama: '', deskripsi: '', image: null }); setErrors({}); onClose(); }
    };
