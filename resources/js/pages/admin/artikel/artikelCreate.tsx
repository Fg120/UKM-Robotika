...
import { Kategori, Tag } from '@/types';
...
export default function ArtikelCreate({ kategoris, tags }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        router.post('/admin/artikel', payload, {
            forceFormData: true,
                        ...
                        <div className="grid gap-4">
                            ...
                            <div>
                                ...
                                <CKEditorComponent
                                    ...
                                    onChange={(data) => setFormData({ ...formData, konten: data })}
                                />
